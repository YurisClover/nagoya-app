...
export default async function EventFormPage({ params,}: {params: Promise<{ eventId: string;}>;}) {
  ...
  const prefilledFormUrl = prefillTemplate.includes( "__MEMBER_ID__",)
   ? prefillTemplate.replace("__MEMBER_ID__", encodeURIComponent( memberId,),) : null;
