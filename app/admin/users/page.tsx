          ...
          <table className="w-full border-collapse text-left text-sm">
            <thead>
              <tr className="border-b bg-gray-50">
                ...
                <th className="w-24 whitespace-nowrap p-3 text-center font-semibold">
                  権限
                </th>
                <th className="w-24 whitespace-nowrap p-3 text-center font-semibold">
                  ステータス
                </th>
                <th className="w-28 whitespace-nowrap p-3 text-center font-semibold">
                  登録日
                </th>
                <th className="w-16 whitespace-nowrap p-3 text-center font-semibold">
                  操作
                </th>
              </tr>
            </thead>
